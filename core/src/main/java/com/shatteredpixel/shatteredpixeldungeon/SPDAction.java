...
public class SPDAction extends GameAction {
	...
	public static final GameAction QUICKSLOT_11 = new SPDAction("quickslot_11");
	public static final GameAction QUICKSLOT_12 = new SPDAction("quickslot_12");
	...
	static {
		...
		defaultBindings.put( Input.Keys.MINUS,          SPDAction.QUICKSLOT_11 );
		defaultBindings.put( Input.Keys.EQUALS,         SPDAction.QUICKSLOT_12 );
